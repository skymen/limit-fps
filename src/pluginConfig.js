...
module.exports = {
  ...
  description: "Set a hard limit on the maximum FPS of your game",
      ...
      params: [
        {
          id: "max_fps",
          name: "Max FPS",
          desc: "Max FPS (Less or equal to 0 to disable)",
          type: "number",
          value: 60,
        },
      ],
      listName: "Set Max FPS",
      displayText: "Set max fps to [i]{0}[/i]",
